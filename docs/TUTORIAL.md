...
Note: If the client prompts "you do not have sufficient permissions to ...", logout of the client and log back in. If  the issue persists, check user privileges to make sure the extention is allowed.
